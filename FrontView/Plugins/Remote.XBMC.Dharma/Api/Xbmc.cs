...
using Plugin;
using Remote.XBMC.DharmaHttp.XbmcHttpApi;
using Setup;
...
namespace Remote.XBMC.Dharma.Api
{
    ...
    public class Xbmc : ApiConnection
    {
        ...
        private string GetInfoLabel(string label)
        {
            var res = JsonCommand("System.GetInfoLabels", new[] { label });
            return res == null ? null : ((JsonObject) res)[label].ToString();
        }
        ...
        {
            var infos = GetInfoLabel("System.BuildVersion");
            return infos ?? "";
        }

        public override string GetAdditionalInfo()
        {
            var infos = GetInfoLabel("System.ProfileName");
            return infos ?? "";
        }
