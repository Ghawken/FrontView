            ...
            if (!MpcLoaded)
            {
                ...
                try
                {
                    ...
                    if (((HttpWebResponse)response).StatusCode == HttpStatusCode.OK)
                    {
                        ...
                        XmlSerializer serializer = new XmlSerializer(typeof(Remote.WMC.Api.Clients2.MediaContainer));
                        Remote.WMC.Api.Clients2.MediaContainer deserialized = (Remote.WMC.Api.Clients2.MediaContainer)serializer.Deserialize(reader);
        ...
        public override int TestConnection(string ip, string port, string user, string password)
        {
            ...
            try
            {
                ...
                if (((HttpWebResponse)response).StatusCode == HttpStatusCode.OK)
                {
                    ...
                    XmlSerializer serializer = new XmlSerializer(typeof(Remote.WMC.Api.Clients.MediaContainer));
                    Remote.WMC.Api.Clients.MediaContainer deserialized = (Remote.WMC.Api.Clients.MediaContainer)serializer.Deserialize(reader);
