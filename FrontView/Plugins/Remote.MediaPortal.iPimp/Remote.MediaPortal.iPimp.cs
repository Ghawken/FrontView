...
namespace Remote.MediaPortal.iPimp
{
    public class MediaPortaliPimp : IYatse2RemotePlugin
    {
        public MediaPortaliPimp()
        {
            Name = "MediaPortal - iPiMP";
        }
        ...
        {
            return new Api.MediaPortal();
        }

        public string GetHashFromFileName(string fileName)
        {
            return Api.MediaPortal.Hash(fileName);
        }
    }
}
