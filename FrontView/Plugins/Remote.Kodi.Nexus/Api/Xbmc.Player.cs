        ...
        public void RefreshNowPlaying()
        {
            lock (Locker)
            {
                ...
                else
                {
                    ...
                    _parent.Log("XBMC-Remote NowPlaying.MediaType:"+_nowPlaying.MediaType);
                    ...
                    if (_nowPlaying.MediaType == "video")
                    {
                        if (result2["type"].ToString() == "channel")  //if PVR Needs to go high otherwise exception
                        {
                            ...
                            _parent.Log("KODI-Remote:nowPlaying PVR.2 isPaysed:" + _nowPlaying.IsPaused.ToString() +" and isPlaying:"+_nowPlaying.IsPlaying.ToString()) ;
